...
public class amazon_app {
    ...
    static ArrayList <merchants> m_List = new ArrayList<merchants>();
    static ArrayList <merchants> app_list = new ArrayList<merchants>();
            ...
            for(int i=0;i<app_list.size();i++){
                ...
                if(show==1){
                    ...
                    if(apprstate.equals("1")){
                        System.out.println("NewMerchand "+app_list.get(i).merchantname+" approved successfully");
    ...
    private static void addmerch() {
        ...
        String newmerchant = scan.next();
        System.out.println("Enter Merchand Password :");
        String newmerchantpass = scan.next();
        System.out.println("Enter Merchand Brand and Details :");
        String newmerchantbrand = scan.next();
        m_List.add(new merchants(newmerchant,newmerchantpass,newmerchantbrand,newmerchid,"approved"));
    ...
    private static void remvmerch() {
       int rem_mer_count =0;
        ...
        int newmerchantid = scan.nextInt();        
        for(int i=0;i<m_List.size();i++){
            if(m_List.get(i).merchantId==newmerchantid){
                System.out.println("Merchand "+m_List.get(i).merchantname+ " Removed successfully....");
                m_List.remove(i);
                rem_mer_count=1;
            }                
        }        
    ...
    private static void new_order() {
        ...
        for(int i=0;i<pro_list.size();i++){
            ...
            pro_list.get(i).product_brand,
            pro_list.get(i).product_details,pro_list.get(i).productId,pro_list.get(i).merchantid,
    ...
    private static void merchant() {
        System.out.println("-----Welcome Merchant Users-----");
    ...
    private static boolean waitmer(ArrayList<merchants> app_list2, int merid, String merpass) {
        for(int i=0;i<app_list2.size();i++){
            if(app_list.get(i).merchantId==(merid) && app_list.get(i).merchantPass.equals(merpass)){
                return true;
            }
        }
        return false;
    ...
    private static void signup() {        
        ...
        newmerchcount++;
        merchants obj =  new merchants(newname,newpass,newBrand,newmerchid,status);
        app_list.add(obj);
        newmerchid++;
        amazonHome();
    ...
    private static void orgmer() {
        System.out.println("-----Welcome Merchand"+m_List.get(index).merchantname+"------");
    ...
    private static void addproduct() {
        ...
        product_id++;
        pro_list.add(new products(new_prod,new_brand,new_detail,product_id,m_List.get(index).merchantId,new_price,new_dis));
    ...
    private static void removeproduct() {
        ...
        int tem_mer=m_List.get(index).merchantId;
        String rempro = scan.next();
        boolean flag = false;
        for(int i=0;i<pro_list.size();i++){
            if(pro_list.get(i).product_name==rempro && tem_mer==pro_list.get(i).merchantid){
    ...
    private static void viewproduct() {
        ...
        System.out.println(s);
        // System.out.println("Product Name\t Product Brand\t\t product details\t\t productId\t merchantId\t productPrice\t Productdiscount");
        int temp_pro = m_List.get(index).merchantId;
        ArrayList< products> tp = new ArrayList<>();
            for(int i=0;i<pro_list.size();i++){
            // System.out.println(pro_list.get(temp_pro).product_name);
            if(pro_list.get(i).merchantid==temp_pro){
    ...
    private static void modifyProduct() {
        ...
        int mod_check = 0;
        for (int i = 0; i < pro_list.size(); i++) {
            if (pro_list.get(i).productId == modify_id && pro_list.get(i).merchantid == m_List.get(index).merchantId) {                
                System.out.print("\033[H\033[2J");
                System.out.flush();
                crtModify(modify_id);
                mod_check = 1;
    ...
    private static boolean checkmer(ArrayList<merchants> m_List2, int merid, String merpass) {
        for(int i=0;i<m_List.size();i++){
            if(m_List.get(i).merchantId==merid && m_List.get(i).merchantPass.equals(merpass)){
                index=i;
                return true;
            }
        }
    ...
    public static void merchantlist(){
        m_List.add(new merchants( "amrith", "1234","Mobiles",101,"approved"));
        m_List.add(new merchants("ram", "2222","Tablets",102,"approved"));
        m_List.add(new merchants("rithik", "3333","Furniture",103,"approved"));
    }
...
class merchants extends amazon_app{
    int merchantId;
    String merchantname;
    String merchantPass,merchantbrand,status;
    merchants(String merchantname,String merchantPass,String merchantbrand,int merchantId,String status){
    ...
    public String toString(){
        return merchantname+"\t"+ merchantPass+" \t"+merchantbrand+" \t"+merchantId +"\t"+status;
    }
}
...
class orders extends amazon_app{
    ...
    int merchantid,orderId;
    String product_brand,product_details,product_name;
    double product_dis,product_price;
    String status;
    orders(int orderId,String product_name,String product_brand,String product_details,
    int product_id,int merchantId,double product_price,double product_dis,int user_Id, String status){
        this.product_name=product_name;
        this.merchantid=merchantId;
        this.product_brand=product_brand;
        this.product_details=product_details;
...
class cart extends amazon_app{
    ...
    int merchantId,double product_price,double product_dis,int user_Id, String status){
        this.product_name=product_name;
        this.merchantid=merchantId;
        this.product_brand=product_brand;
        this.product_details=product_details;
